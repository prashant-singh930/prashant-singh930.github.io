...
const calculateRiskScore = (rawData) => {
  ...
  if (data.oldpeak > 1.5) riskFactors.push("High ST Depression (Oldpeak)");
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 md:p-8">
      ...
      <div className="text-center mb-8 slide-in">
        ...
        <p className="text-gray-500 max-w-lg mx-auto">
          Enter patient metrics below. The logic is calibrated to the UCI Heart
          Disease dataset patterns.
        </p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8 w-full max-w-6xl">
        ...
        >
          ...
          >
            {isAnalyzing ? "Analyzing Clinical Data..." : "Predict Risk Factor"}
          </button>
        </div>
                ...
                <div className="relative w-48 h-48 mx-auto mb-6">
                  ...
                  <svg className="w-full h-full" viewBox="0 0 36 36">
                    ...
                    <path
                      d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"
                      fill="none"
                      stroke={result.percentage > 50 ? "#ef4444" : "#22c55e"}
                      strokeWidth="3"
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-800 leading-relaxed">
                  This tool uses a weighted scoring algorithm derived from the
                  correlations in the `heart.csv` dataset. Note that in this
                  specific dataset, <strong>Exercise Angina</strong> and{" "}
                  <strong>Number of Vessels (CA)</strong> are strong indicators.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="mt-12 text-center text-gray-400 text-sm pb-8">
        <p>
          © 2024 Heart Prediction Logic. For informational purposes only.
          Consult a doctor.
        </p>
      </footer>
    </div>
